 ...
 */
package com.dhfr.cash.optimum.service.impl;
...
public class PasswordComplexityServiceImpl extends IServiceImpl implements PasswordComplexityService {
    ...
    public void update(PasswordComplexity entity) throws Exception {
        PasswordComplexity complexity = passwordComplexityDao.getByCode(entity.getCode());
        complexity.setNotificationPeriod(4);
        passwordComplexityDao.update(complexity);
    }
    ...
    public PasswordComplexity getByCode(String code) throws Exception {
        return passwordComplexityDao.getByCode(code);
